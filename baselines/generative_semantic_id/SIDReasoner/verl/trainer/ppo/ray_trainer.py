...
_WANDB_METRIC_ORDER = (
    ...
    "core_metrics_val/02_overall_hr_at_5",
    "core_metrics_val/03_overall_hr_at_10",
    "core_metrics_val/04_overall_ndcg_at_1",
    "core_metrics_val/05_overall_ndcg_at_5",
    "core_metrics_val/06_overall_ndcg_at_10",
    "core_metrics_val/11_novel_hr_at_5",
    "core_metrics_val/12_novel_hr_at_10",
    "core_metrics_val/13_novel_ndcg_at_5",
    "core_metrics_val/14_novel_ndcg_at_10",
    "core_metrics_val/21_repeat_hr_at_5",
    "core_metrics_val/22_repeat_hr_at_10",
    "core_metrics_val/23_repeat_ndcg_at_5",
    "core_metrics_val/24_repeat_ndcg_at_10",
    "core_metrics_val/31_format_reward_mean",
    "core_metrics_val/32_history_summary_grounding_reward_mean",
    "core_metrics_val/33_future_interests_grounding_reward_mean",
    "core_metrics_val/34_history_reference_coverage_mean",
    "core_metrics_val/35_latest_history_summary_reference_reward_mean",
    "core_metrics_val/36_process_reward_mean",
    "core_metrics_val/41_sid_diversity_mean",
...
class RayPPOTrainer:
    ...
    def _validate(self):
        ...
        validation_core_metrics = {
            ...
            "format_reward": "core_metrics_val/31_format_reward_mean",
            "history_summary_grounding_reward": "core_metrics_val/32_history_summary_grounding_reward_mean",
            "future_interests_grounding_reward": "core_metrics_val/33_future_interests_grounding_reward_mean",
            "history_reference_coverage": "core_metrics_val/34_history_reference_coverage_mean",
            "latest_history_summary_reference_reward": "core_metrics_val/35_latest_history_summary_reference_reward_mean",
            "process_reward": "core_metrics_val/36_process_reward_mean",
            "sid_eval_diversity": "core_metrics_val/41_sid_diversity_mean",
            ...
            "sid_eval_hr_at_5": "core_metrics_val/02_overall_hr_at_5",
            "sid_eval_hr_at_10": "core_metrics_val/03_overall_hr_at_10",
            "sid_eval_ndcg_at_1": "core_metrics_val/04_overall_ndcg_at_1",
            "sid_eval_ndcg_at_3": "core_metrics_val/ndcg_at_3",
            "sid_eval_ndcg_at_5": "core_metrics_val/05_overall_ndcg_at_5",
            "sid_eval_ndcg_at_10": "core_metrics_val/06_overall_ndcg_at_10",
            "sid_eval_novel_hr_at_5": "core_metrics_val/11_novel_hr_at_5",
            "sid_eval_novel_hr_at_10": "core_metrics_val/12_novel_hr_at_10",
            "sid_eval_novel_ndcg_at_5": "core_metrics_val/13_novel_ndcg_at_5",
            "sid_eval_novel_ndcg_at_10": "core_metrics_val/14_novel_ndcg_at_10",
            "sid_eval_repeat_hr_at_5": "core_metrics_val/21_repeat_hr_at_5",
            "sid_eval_repeat_hr_at_10": "core_metrics_val/22_repeat_hr_at_10",
            "sid_eval_repeat_ndcg_at_5": "core_metrics_val/23_repeat_ndcg_at_5",
            "sid_eval_repeat_ndcg_at_10": "core_metrics_val/24_repeat_ndcg_at_10",
        }
